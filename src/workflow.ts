  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        branch_id:    { type: ["string", "number"] as never, description: "Branch ID — required for correct results" },
        service_id:   { type: ["string", "number"] as never, description: "Service ID from services[].id — required for correct results" },
      },
