...
interface McpToolResult {
  [key: string]: unknown; // index signature required by the SDK's CallToolResult
...
function toMcpResult(result: ToolHandlerResult<unknown>): McpToolResult {
  if (result.isError) {
...
export function registerTherapistTools(server: McpServer): void {
  ...
  server.registerTool(
    ...
    async (params: ListInput) => toMcpResult(await handleFindTherapists(params))
  );
  ...
  server.registerTool(
    ...
    async (params: GetInput) => toMcpResult(await handleGetTherapist(params))
  );
  ...
  server.registerTool(
    ...
    async (params: HoursInput) => toMcpResult(await handleGetTherapistHours(params))
  );
  ...
  server.registerTool(
    ...
    async (params: AvailableDaysInput) =>
      toMcpResult(await handleGetTherapistAvailableDays(params))
  );
