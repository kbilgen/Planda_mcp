...
export const FEW_SHOT_EXAMPLES = [
  ...
  },
  {
    ...
    assistant_behavior:
      "Tanı KENDİLİĞİNDEN paylaşıldı — tekrar sorma, yorum yapma, tanı adını cevapta tekrar etme. Sadece uzmanlık filtresine çevir: find_therapists({ specialty_name:'kaygı' }) (modalite/şehir merdiveni normal işler). Cevapta 'bahsettiğin ihtiyaca uygun' gibi konuş.",
  },
  {
    user: "Artık dayanamıyorum, işe bile gidemiyorum",
    assistant_behavior:
      "Şiddet sinyali var (kriz değil). Kısa empati + GEÇMİŞ DESTEK opsiyonel sorusu sorulabilir: 'İstersen paylaşabilirsin, tamamen sana kalmış: daha önce psikolojik destek aldın mı?' Cevap gelince normal merdiven akışına dön. Kriz sinyali (intihar/kendine zarar) olsaydı → KRİZ DURUMU.",
  },
];
