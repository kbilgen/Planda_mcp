 ...
 */
export function diversifyRanking(therapists, opts = {}) {
    const enabled = opts.enabled ?? isDiversifyEnabled();
    if (!enabled || therapists.length <= 1)
        return therapists;
...
//# sourceMappingURL=therapistRanker.js.map