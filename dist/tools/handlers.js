...
import { findTherapists, getTherapist, getTherapistByUsername, listSpecialties as apiListSpecialties, getTherapistHours as apiGetTherapistHours, getTherapistAvailableDays as apiGetTherapistAvailableDays, getActiveCities as apiGetActiveCities, } from "../services/therapistApi.js";
...
// ─── Handlers ────────────────────────────────────────────────────────────────
export async function handleFindTherapists(params) {
    try {
        ...
        return { text: handleApiError(error), structured: undefined, isError: true };
    }
}
export async function handleGetTherapist(params) {
    try {
...
export async function handleListSpecialties() {
    try {
...
export async function handleGetTherapistHours(params) {
    try {
...
export async function handleGetTherapistAvailableDays(params) {
    try {
