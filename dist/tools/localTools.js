...
export function buildLocalTools() {
    return [
        tool({
            ...
            strict: false,
            execute: (input) => validateAndRun(ListInputSchema, input, handleFindTherapists),
        }),
        tool({
            name: "get_therapist",
            ...
            strict: false,
            execute: (input) => validateAndRun(GetInputSchema, input, handleGetTherapist),
        }),
        tool({
        ...
        tool({
            ...
            strict: false,
            execute: (input) => validateAndRun(HoursInputSchema, input, handleGetTherapistHours),
        }),
        tool({
            ...
            strict: false,
            execute: (input) => validateAndRun(AvailableDaysInputSchema, input, handleGetTherapistAvailableDays),
        }),
    ];
}
