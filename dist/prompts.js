...
export const FEW_SHOT_EXAMPLES = [
    {
        ...
        assistant_behavior: "Şehir ve problem alanı net. Soru sormadan find_therapists kullan, sonuçları AI-side filtrele, en fazla 2-3 terapist öner.",
    },
    {
        user: "Ayşe Yılmaz müsait mi bu hafta?",
        assistant_behavior: "Bu bir müsaitlik sorgusu. Gerekirse önce find_therapists ile kişiyi bul, sonra get_therapist_available_days kullan. Gerekirse yeniden canlı veri çek. Liste önerme.",
    },
    {
        user: "bdt terapisti arıyorum",
        assistant_behavior: "Yaklaşım sorgusu, tek kelime bile yeterli. Şehir/online sormadan find_therapists({approach_name:'BDT'}) çağır. Server zaten approaches[]'ı doğrular; ek tool yok. 0 sonuç gelirse uydurma — 'görünmüyor' de.",
    },
    {
        user: "BDT yapan online terapist var mı?",
        assistant_behavior: "Yaklaşım + online filtresi. find_therapists({approach_name:'BDT', online:true}) — TEK çağrı yeter. specialty_name veya name'e BDT yazma; bu yaklaşımdır.",
    },
    {
        user: "EMDR uzmanı arıyorum İstanbul'da",
        assistant_behavior: "find_therapists({approach_name:'EMDR', city:'İstanbul'}) — tek çağrı.",
    },
    {
        user: "Ekin Alankuş kim?",
        assistant_behavior: "Bu bir isim sorgusu. City sormadan find_therapists(per_page=500) kullan, kişiyi bul, bilgiyi düz metin ver ve [[expert:username]] ekle.",
    },
    {
        user: "Çocuğum için terapist arıyorum",
        assistant_behavior: "Başkası (çocuk) sinyali var ama yaş yok. Tek takip sorusu olarak yaşı sor: 'Çocuğunuz kaç yaşında?'. Yaş gelince find_therapists'e age parametresiyle geç; sunucu uygun yaş grubunu eler.",
    },
    {
